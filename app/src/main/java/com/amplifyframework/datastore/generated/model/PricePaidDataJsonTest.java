...
/** This is an auto generated class representing the PricePaidDataJsonTest type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "PricePaidDataJsonTests")
@Index(name = "postcode-index", fields = {"postcode"})
public final class PricePaidDataJsonTest implements Model {
  ...
  private PricePaidDataJsonTest(String id, String postcode, List<String> locationPaidB) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      PricePaidDataJsonTest pricePaidDataJsonTest = (PricePaidDataJsonTest) obj;
      return ObjectsCompat.equals(getId(), pricePaidDataJsonTest.getId()) &&
              ObjectsCompat.equals(getPostcode(), pricePaidDataJsonTest.getPostcode()) &&
              ObjectsCompat.equals(getLocationPaidB(), pricePaidDataJsonTest.getLocationPaidB());
      }
  }
   ...
   */
  public static PricePaidDataJsonTest justId(String id) {
    try {
    ...
    return new PricePaidDataJsonTest(
      id,
      null,
      null
    );
  ...
  public static class Builder implements LocationPaidBStep, BuildStep {
    ...
    @Override
     public PricePaidDataJsonTest build() {
