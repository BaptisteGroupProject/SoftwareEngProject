...
/** This is an auto generated class representing the LocationPricePaidDataByJson type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "LocationPricePaidDataByJsons")
public final class LocationPricePaidDataByJson implements Model {
  ...
  private LocationPricePaidDataByJson(String id, String postcode, List<String> locationPaidB) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      LocationPricePaidDataByJson locationPricePaidDataByJson = (LocationPricePaidDataByJson) obj;
      return ObjectsCompat.equals(getId(), locationPricePaidDataByJson.getId()) &&
              ObjectsCompat.equals(getPostcode(), locationPricePaidDataByJson.getPostcode()) &&
              ObjectsCompat.equals(getLocationPaidB(), locationPricePaidDataByJson.getLocationPaidB());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      .append("LocationPricePaidDataByJson {")
   ...
   */
  public static LocationPricePaidDataByJson justId(String id) {
    try {
    ...
    return new LocationPricePaidDataByJson(
      id,
      null,
      null
    );
  ...
  public interface BuildStep {
    LocationPricePaidDataByJson build();
  ...
  public static class Builder implements LocationPaidBStep, BuildStep {
    ...
    @Override
     public LocationPricePaidDataByJson build() {
