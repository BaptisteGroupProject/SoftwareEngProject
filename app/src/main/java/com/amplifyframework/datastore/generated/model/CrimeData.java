...
/** This is an auto generated class representing the CrimeData type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "CrimeData")
@Index(name = "latng-index", fields = {"longitude","latitude"})
public final class CrimeData implements Model {
  ...
  private CrimeData(String id, String crimeId, String month, String reportedBy, String fallsWithin, Float longitude, Float latitude, String location, String LSOACode, String LSOAName, String CrimeType, String lastOutCome, String Context) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      CrimeData crimeData = (CrimeData) obj;
      return ObjectsCompat.equals(getId(), crimeData.getId()) &&
              ObjectsCompat.equals(getCrimeId(), crimeData.getCrimeId()) &&
              ObjectsCompat.equals(getMonth(), crimeData.getMonth()) &&
              ObjectsCompat.equals(getReportedBy(), crimeData.getReportedBy()) &&
              ObjectsCompat.equals(getFallsWithin(), crimeData.getFallsWithin()) &&
              ObjectsCompat.equals(getLongitude(), crimeData.getLongitude()) &&
              ObjectsCompat.equals(getLatitude(), crimeData.getLatitude()) &&
              ObjectsCompat.equals(getLocation(), crimeData.getLocation()) &&
              ObjectsCompat.equals(getLsoaCode(), crimeData.getLsoaCode()) &&
              ObjectsCompat.equals(getLsoaName(), crimeData.getLsoaName()) &&
              ObjectsCompat.equals(getCrimeType(), crimeData.getCrimeType()) &&
              ObjectsCompat.equals(getLastOutCome(), crimeData.getLastOutCome()) &&
              ObjectsCompat.equals(getContext(), crimeData.getContext());
      }
  }
   ...
   */
  public static CrimeData justId(String id) {
    try {
