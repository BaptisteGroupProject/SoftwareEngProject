...
/** This is an auto generated class representing the LocationPlaceByJson type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "LocationPlaceByJsons")
public final class LocationPlaceByJson implements Model {
  ...
  private LocationPlaceByJson(String id, String firstPostcode, List<String> locationItems) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      LocationPlaceByJson locationPlaceByJson = (LocationPlaceByJson) obj;
      return ObjectsCompat.equals(getId(), locationPlaceByJson.getId()) &&
              ObjectsCompat.equals(getFirstPostcode(), locationPlaceByJson.getFirstPostcode()) &&
              ObjectsCompat.equals(getLocationItems(), locationPlaceByJson.getLocationItems());
      }
  }
   ...
   */
  public static LocationPlaceByJson justId(String id) {
    try {
    ...
    return new LocationPlaceByJson(
      id,
      null,
      null
    );
  ...
  public static class Builder implements LocationItemsStep, BuildStep {
    ...
    @Override
     public LocationPlaceByJson build() {
